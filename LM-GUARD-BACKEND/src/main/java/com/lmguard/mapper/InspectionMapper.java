...
public class InspectionMapper {
    ...
    public InspectionResponse toResponse(Inspection inspection,
        ...
        return new InspectionResponse(
                ...
                inspection.getAiSuggestedStatus(),
                ...
                inspection.getZone() == null ? null : inspection.getZone().getId(),
                inspection.getZone() == null ? null : inspection.getZone().getName(),
                inspection.getEstablishment(),
