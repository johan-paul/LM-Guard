...
public record DashboardStatisticsResponse(
        ...
        @Schema(description = "Manufacturers with 2 or more substantiated violations on record", example = "6")
        long repeatOffenderCount,

        @Schema(description = "Violation cases currently escalated for enforcement review", example = "3")
