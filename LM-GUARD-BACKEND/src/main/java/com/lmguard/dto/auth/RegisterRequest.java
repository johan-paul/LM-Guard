...
public record RegisterRequest(
        ...
        @Schema(description = "Accepted for backward compatibility; the only role this endpoint will ever "
                + "create is INSPECTOR. A request naming ADMIN is rejected (403), not downgraded.",
                example = "INSPECTOR")
        Role role
) {
}
