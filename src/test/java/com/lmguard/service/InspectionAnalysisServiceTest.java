...
class InspectionAnalysisServiceTest {
    ...
    void nonCompliantPackage() {
        ...
        assertThat(response.status()).isEqualTo(InspectionStatus.NON_COMPLIANT);
    ...
    void compliantPackage() {
        ...
        assertThat(response.status()).isEqualTo(InspectionStatus.COMPLIANT);
    ...
    void inconclusivePackage() {
        ...
        assertThat(response.status()).isEqualTo(InspectionStatus.INCONCLUSIVE);
